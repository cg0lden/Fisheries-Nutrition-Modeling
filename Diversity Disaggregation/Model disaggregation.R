...
FoodConsumptionBase <- read_csv("data/FoodConsBaseRev3.csv") %>% mutate(scenario = "base")
FoodConsumptionScenario <- read_csv("data/FoodConsScenRev3.csv") %>% mutate(scenario = "high")
BaseNutrients <- read_csv("data/NutrientsBaseRev3.csv") %>% mutate(scenario = "base")
ScenarioNutrients <- read_csv("data/NutrientsScenRev3.csv") %>% mutate(scenario = "high")
