...
##Read GENuS data
genus_edible_food_by_cntry_year <- readRDS("~/MPA_Nutrition/genus_edible_food_by_cntry_year.Rds")
...
genus_nutrient_supplies_by_cntry_food_2011 <- readRDS("~/MPA_Nutrition/genus_nutrient_supplies_by_cntry_food_2011.Rds")
...
##Load GENuS data
genus_nutrient_supplies_by_age_sex_2011 <- readRDS("~/MPA_Nutrition/genus_nutrient_supplies_w_fort_by_age_sex_2011.Rds")
##Calculate Miller equation
source("zinc_absorption_Miller_tidyverse.R")
...
genus_nutrient = genus_nutrient %>% 
  mutate(vulnerability = value_med/(1.5*EAR))
...
All_countries=All_countries %>%
  mutate(composite=if_else(limiting>10,marine_condition+freshwater_condition,0),
         limiting_nutrient_vulneraility = if_else(limiting<50, 0, 
                                                  if_else(limiting>75, 2, 1)),
         Nutritional_dependence_and_vulnerability = composite*limiting_nutrient_vulneraility)  #criteria above 10% considered vulnerable
