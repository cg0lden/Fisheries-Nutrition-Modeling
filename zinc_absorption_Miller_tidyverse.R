...
genus_nutrient_supplies_by_age_sex_2011_zincAbsorbe <-readRDS("~/MPA_Nutrition/genus_nutrient_supplies_w_fort_by_age_sex_2011.Rds") %>%
...
zinc_phytate_table <- readRDS("~/MPA_Nutrition/zinc_phytate_table.Rda")
edible_per_age_sex_2011 <- readRDS("~/MPA_Nutrition/genus_edible_food_by_age_sex_2011.Rds")
